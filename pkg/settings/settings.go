...
var (
	...
	LonghornConfig                         = NewSetting(LonghornConfigSettingName, `{"v2-data-engine": false, "data-engine-hugepage-enabled": {"v2": "true"}, "data-engine-memory-size": {"v2": "2048"}}`)
...
const (
	...
	LonghornConfigSettingName						  = "longhorn-config"
